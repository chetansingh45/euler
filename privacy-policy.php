<?php
		...
		////selecting hero data
		$hero = $db->db("SELECT * FROM privacy_policy_page WHERE section_name = 'hero'");
		$heroData = false;
		...
		$sectionTwo = $db->db("SELECT * FROM privacy_policy_page WHERE section_name = 'section_two'");
