...
<div class="page-main-header">
    <div class="main-header-left">
        <div class="logo-wrapper"><a href="index.php"><img class="blur-up lazyloaded" src="https://maryjane-assests.s3.ap-south-1.amazonaws.com/images/logo.png" alt=""></a></div>
    </div>
            ...
            <ul class="nav-menus">
                ...
                <li class="onhover-dropdown">
                    <div class="media align-items-center">
                        <!--<img class="align-self-center pull-right img-50 rounded-circle blur-up lazyloaded" src="https://maryjane-assests.s3.ap-south-1.amazonaws.com/images/man.png" alt="header-user">-->
                        <i data-feather="user" class="align-self-end pull-right img-50 rounded-circle blur-up lazyloaded"></i>
                        <div class="dotted-animation"><span class="animate-circle"></span><span class="main-circle"></span></div>
                    </div>
                    <ul class="profile-dropdown onhover-show-div p-20 profile-dropdown-hover">
                        <!--<li><a href="javascript:void(0)">Profile<span class="pull-right"><i data-feather="user"></i></span></a></li>-->
                        <li><a href="./php/module/auth/logout.php">Logout<span class="pull-right"><i data-feather="logout"></i></span></a></li>
                    </ul>
                </li>
            </ul>
