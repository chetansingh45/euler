...
$section_meta = $db->db("SELECT * FROM dealership_page WHERE section_name = 'meta'");
if (isset($_POST['save_meta'])) {
    ...
    if (mysqli_num_rows($section_meta) > 0) {
        $res = $db->db("UPDATE dealership_page SET main_title='$main_title',main_description='$main_description' WHERE section_name='meta'");
        if ($res) {
            alert("Updated", "Meta Updated Successfully", "success");
        }
    } else {
        $sql = "INSERT INTO dealership_page (section_name,main_title,main_description)
...
$meta_data = false;
$meta = $db->db("SELECT * FROM dealership_page WHERE section_name = 'meta'");
if (mysqli_num_rows($meta) > 0) {
    $meta_data = mysqli_fetch_assoc($meta);
}

//////---------Saving And updating hero section--------------////////////////////////////////////////////////
$carrer = $db->db("SELECT * FROM dealership_page WHERE section_name = 'hero'");
...
if (isset($_POST['save_hero_section'])) {
    ...
    if (mysqli_num_rows($carrer) > 0) {
        $res = $db->db("UPDATE dealership_page SET main_title='$main_title',main_image='$main_image',title='$title' WHERE section_name='hero'");
        if ($res) {
            alert("Updated", "Hero Section Updated Successfully", "success");
        }
    } else {
        $res = $db->db("INSERT INTO dealership_page (section_name,main_title,main_image,title)
                VALUES ('hero','$main_title','$main_image','$title')");
        if ($res) {
...
$section_two = $db->db("SELECT * FROM dealership_page WHERE section_name = 'section_two'");
...
if (isset($_POST['save_section_two'])) {
    ...
    if (mysqli_num_rows($section_two) > 0) {
        $res = $db->db("UPDATE dealership_page SET main_description='$main_description',main_title='$main_title',btn_text='$btn_text' WHERE section_name='section_two'");
        if ($res) {
            alert("Updated", "Section Two Updated Successfully", "success");
        }
    } else {
        $sql = "INSERT INTO dealership_page (section_name,main_title,btn_text,main_description)
        VALUES ('section_two','$main_title','$btn_text','$main_description')";
...
<div class="d-flex align-items-center mb-4 flex-wrap">
    <h4 class="fs-20 font-w600  me-auto">CMS Dealership</h4>
</div>
<!-- Meta Details -->
<div class="row">
    <div class="col-xl-12">
            ...
            <div class="card">
                <div class="bg-primary sec-head">
                    ...
                    <div class="form-check form-switch float-end d-inline-block my-3 px-4">
                        <input class="form-check-input" onchange="changeStatus('dealership_page', <?php echo $meta_data['id'] ?>, this)" type="checkbox" role="switch" id="flexSwitchCheckDefault" style="width: 2.5em;" <?php echo $meta_data['status'] === '1' ? 'checked' : '' ?>>
            ...
            <form method="post" enctype="multipart/form-data">
                <div class="card">
                    <div class="bg-primary sec-head">
                        ...
                        <div class="form-check form-switch float-end d-inline-block my-3 px-4">
                            <input class="form-check-input" onchange="changeStatus('dealership_page', <?php echo $careerData['id'] ?>, this)" type="checkbox" role="switch" id="flexSwitchCheckDefault" style="width: 2.5em;" <?php echo $careerData['status'] === '1' ? 'checked' : '' ?>>
                            <label class="form-check-label text-white" for="flexSwitchCheckDefault">Hide/Show</label>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-xl-6  col-md-6 mb-4">
                                <label class="form-label font-w600">Sub Title<span class="text-danger scale5 ms-2">*</span></label>
                                <input required type="text" class="form-control solid" name="title" placeholder="Main Title" aria-label="name" <?php if ($careerData) { ?> value="<?php echo $careerData['title'] ?>" <?php } ?>>
                            </div>
                            <div class="col-xl-6  col-md-6 mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input required type="text" name="main_image" class="form-control solid" <?php if ($careerData) { ?> value="<?php echo $careerData['main_image'] ?>" <?php } ?>>
                                </div>
                            </div>
            ...
            <form method="post" enctype="multipart/form-data">
                <div class="card">
                    <div class="bg-primary sec-head">
                        ...
                        <div class="form-check form-switch float-end d-inline-block my-3 px-4">
                            <input class="form-check-input" onchange="changeStatus('dealership_page', <?php echo $section_two_data['id'] ?>, this)" type="checkbox" role="switch" id="flexSwitchCheckDefault" style="width: 2.5em;" <?php echo $section_two_data['status'] === '1' ? 'checked' : '' ?>>
                            <label class="form-check-label text-white" for="flexSwitchCheckDefault">Hide/Show</label>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-xl-6  col-md-6 mb-4">
                                <label class="form-label font-w600">Title<span class="text-danger scale5 ms-2">*</span></label>
                                <input type="text" value="<?php if ($section_two_data) {
                                                                echo $section_two_data['main_title'];
                                                            } ?>" required name="main_title" class="form-control solid" aria-label="name">
                            </div>
                            <div class="col-xl-6  col-md-6 mb-4">
                                <label class="form-label font-w600">Button Text<span class="text-danger scale5 ms-2">*</span></label>
                                <input type="text" value="<?php if ($section_two_data) {
                                                                echo $section_two_data['btn_text'];
                                                            } ?>" required name="btn_text" class="form-control solid" aria-label="name">
                            </div>
