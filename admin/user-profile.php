...
<div class="d-flex align-items-center mb-4">
    ...
    <div>
        <a href="javascript:void(0);" class="btn btn-primary btn-sm me-3"> <i class="fas fa-envelope me-1"></i> Mail</a>
        <a href="javascript:void(0);" class="btn btn-primary btn-sm me-3"><i class="fas fa-phone-alt me-1"></i> Contact</a>
    </div>
</div>
<div class="card">
    <div class="card-header border-0 flex-wrap align-items-start">
        <div class="col-md-8">
            <div class="user d-sm-flex align-items-start d-block pe-md-5 pe-0">
                <img src="images/user.png">
                <div class="ms-sm-3 ms-0 me-md-5 md-0">
                    <h5 class="mb-1 font-w600"><a href="javascript:void(0);">Andrew Jonson</a></h5>
        ...
        <div class="col-md-4 col-12 text-end">	
            <a href="javascript:void(0);" class="btn btn-sm btn-primary me-2">Hire</a>
